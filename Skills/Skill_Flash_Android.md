...
- **IMMEDIATELY ask** the user: "What is the exact model of the phone you want to flash? (e.x: SM-S908B, SM-G998B)"
...
2. Choose the correct carrier code or unlocked region (e.x., MEO, TPH, or EUX).
